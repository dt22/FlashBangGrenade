...
- FlashBangGrenadeConfig.cs: Example of ModConfig for custom mod settings;
- FlashBangGrenadeGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- FlashBangGrenadeMain.cs: Main mod class, recieves mod management and general events;
- FlashBangGrenadeTactical.cs: Example of ModTactical for modifying tactical level;
